...
AQUI FEM LES GRÀFIQUES I FIQUEM LES MATEIXES FORMULES QUE HI HA AL EXEMPLE
...
Farem la prova de Shapiro wilk https://www.rdocumentation.org/packages/stats/versions/3.6.1/topics/shapiro.test explica que es http://www.sthda.com/english/wiki/normality-test-in-r
test de normalidad
...
utilitzem pearson perquè assumim una distribució normal de tots els atributs pe teorema del limit central
...
YEAR ES UNA VARIABLE QUE NO SIRVE PARA NADA PODRIEM ELIMINAR-LA. 

La variable més rellevant es logwage, seguida de age per molta distància.
